...
# Functie om live video te verwerken
def process_video():
    cap = cv2.VideoCapture(1)  # Gebruik de eerste aangesloten camera (of vervang met een bestandspad voor video)
    ...
    while True:
        ...
        if contours:
            ...
            # Verzenden naar TwinCAT (rate-limited)
            send_coordinates_to_twincat(x_coords, y_coords)

            # Opslaan in CSV (optioneel: of log continu)
